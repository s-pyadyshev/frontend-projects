...
$(function () {
  if ($(".counter-value").length) {
    ...
    var reset = function reset() {
      ...
      if (isCounterInView && $(".counter-value").isInViewport() && isCounterAnimated === false) {
        animateDigits();
  ...
  var buttons = document.querySelectorAll(".page-header__buttons button");
  var headerImage = document.querySelector(".page-header");
  buttons.forEach(function (button) {
    button.addEventListener("click", function () {
      ...
      var dataImage = button.getAttribute("data-image");
      headerImage.className = "page-header ".concat(dataImage);
    });
  });
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".js-signature-slider", {
  ...
  function smoothScroll(e) {
    ...
    var offsetTop = document.querySelector(link).offsetTop;
    scroll({
      top: offsetTop,
      behavior: "smooth"
    });
